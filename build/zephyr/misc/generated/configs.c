...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_RASPBERRYPI_PICO_PIO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_RASPBERRYPI_PICO_SPI_PIO_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PICOSDK_USE_PIO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RPI_PICO_RP2040_W, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PIO_RPI_PICO, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x2E8A);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x000C);
